...
class BusniessFragment : Fragment(),NewsItemClicked {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_busniess, container, false)
        val recyclerView = view.findViewById<RecyclerView>(R.id.recyclerview1)
        recyclerView.layoutManager = LinearLayoutManager(context)
        recyclerView.hasFixedSize()


        val url = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=017688d9c55f46d493bfb4b3391d3c35"
